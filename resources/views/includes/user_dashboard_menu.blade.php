...
@endif -->
    ...
    <ul class="usernavdash">
        ...
        <li class="{{ Request::url() == route('job.list') ? 'active' : '' }}"><a href="{{ route('job.list') }}"><i class="fas fa-search" aria-hidden="true"></i> {{__('Search Jobs')}}</a>
        </li>
        <li class="{{ Request::url() == route('my.profile') ? 'active' : '' }}"><a href="{{ route('my.profile') }}"><i class="fas fa-user" aria-hidden="true"></i> {{__('My Profile')}}</a>
        </li>
