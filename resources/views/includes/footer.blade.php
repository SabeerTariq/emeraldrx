{{-- Footer Hidden - Commented out to hide from all pages --}}
{{--
...
<div class="copyright">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="bttxt">{{__('Copyright')}} &copy; {{date('Y')}} {{ $siteSetting->site_name }}. {{__('All Rights Reserved')}}. {{__('Design by')}}: <a href="https://piratestechnologies.com/" target="_blank"></a></div>
            </div>
            <!-- <div class="col-md-4">
